...
function get20s(artists){
  for (i=0; artists[i].years >= 1900 && artists[i].years <= 2000; i++)
}
...
function addArtist(artists){
  const addThisArtist = {id,name, years,genre,nationality,bio} 
...
function lotsOfArt(artists){
  for(i=0;artists[i].paintings >= 100; i++)
}
